    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 border-green-400/30 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-300 text-sm font-medium">USD Balance</p>
                  <p className="text-3xl font-bold text-green-400">$5,000.00</p>
          ...
          <Card className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 border-orange-400/30 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-orange-300 text-sm font-medium">Pi Balance</p>
                  <p className="text-3xl font-bold text-orange-400">5,000.0000</p>
          ...
          <Card className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 border-blue-400/30 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-300 text-sm font-medium">Current Price</p>
          ...
          <Card className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 border-purple-400/30 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-300 text-sm font-medium">Portfolio Value</p>
                  <p className="text-3xl font-bold text-purple-400">$7,500.00</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          <Card className="lg:col-span-2 bg-slate-800/30 border-slate-700/50 backdrop-blur-sm shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="text-center p-4 bg-blue-500/10 rounded-lg border border-blue-400/20">
                    <p className="text-blue-300 text-sm">Current Rate</p>
                    <p className="text-2xl font-bold text-blue-400">$0.5000 per π</p>
                  </div>
                </div>
          ...
          <CardContent className="p-0">
            <div className="space-y-0">
              {recentTrades.map((trade, index) => (
                <div key={index} className="flex items-center justify-between p-4 border-b border-slate-700/30 last:border-b-0 hover:bg-slate-700/20 transition-colors">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-300 text-sm">{trade.time}</p>
                    </div>
                  </div>
